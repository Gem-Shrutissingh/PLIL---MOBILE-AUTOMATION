...
//    public static By eKycCheckBox = AppiumBy.id("ion-tg-0");
    ...
    public static By loadingBoxSpinner= AppiumBy.xpath("//android.app.Dialog/android.widget.TextView[1]");
    ...
    public static By growthFundValue = AppiumBy.xpath("(//android.view.View//android.widget.EditText)[3]");
    public static By debtFundValue  = AppiumBy.xpath("(//android.view.View//android.widget.EditText)[1]");
    public static By balFundValue  = AppiumBy.xpath("(//android.view.View//android.widget.EditText)[5]");
    public static By lCapFundValue  = AppiumBy.xpath("(//android.view.View//android.widget.EditText)[7]");
    public static By stpToggle  = AppiumBy.id("ion-tg-3");
    public static By btn_calcBenefit = AppiumBy.xpath("//android.widget.Button[contains(@text,'CALCULATE')]");
